...
struct server_task_result_cmpl_final : server_task_result {
    ...
    virtual void update(task_result_state & state) override {
        ...
        // Native and text-completion responses return the generated bytes as-is.
        // Running them through the chat parser can reject valid special-token
        // output even though these response formats do not consume chat fields.
