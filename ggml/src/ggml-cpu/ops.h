...
void ggml_compute_forward_msa_block_top_k(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_msa_sparse_attn(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_msa_block_mask(const struct ggml_compute_params * params, struct ggml_tensor * dst);
