...
struct llama_hparams {
    ...
    // old glm5next GGUFs predate this key and use sharing
    bool indexer_index_share_mtp = true;
    // MSA
    ...
    // Source layer for each shared DeepSeek-V4.1 cache stream, or -1 when unused.
